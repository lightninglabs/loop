...
func (m *Manager) CreateFinalizedWithdrawalTx(ctx context.Context,
	...
	sigResp, err := m.cfg.StaticAddressServerClient.ServerWithdrawDeposits(
...
func (m *Manager) signMusig2Tx(ctx context.Context,
	...
	sigInfo map[string]*staticaddressrpc.ServerWithdrawSigningInfo,
...
func (m *Manager) createWithdrawalTx(ctx context.Context,
	...
	withdrawalAmount, changeAmount, err := CalculateWithdrawalTxValaues(
		deposits, selectedWithdrawalAmount, fundmax, feeRate,
...
func CalculateWithdrawalTxValaues(deposits []*deposit.Deposit,
	localAmount btcutil.Amount, fundMax bool,
	feeRate chainfee.SatPerKWeight, withdrawalAddress btcutil.Address,

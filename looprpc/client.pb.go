...
type GetLiquidityParamsResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	// A map of asset ids to liquidity rules that describe the desired liquidity
	// balance.
	Rules map[string]*LiquidityParameters `protobuf:"bytes,1,rep,name=rules,proto3" json:"rules,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
}

func (x *GetLiquidityParamsResponse) Reset() {
	*x = GetLiquidityParamsResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *GetLiquidityParamsResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetLiquidityParamsResponse) ProtoMessage() {}

func (x *GetLiquidityParamsResponse) ProtoReflect() protoreflect.Message {
	mi := &file_client_proto_msgTypes[26]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetLiquidityParamsResponse.ProtoReflect.Descriptor instead.
func (*GetLiquidityParamsResponse) Descriptor() ([]byte, []int) {
	return file_client_proto_rawDescGZIP(), []int{26}
}

func (x *GetLiquidityParamsResponse) GetRules() map[string]*LiquidityParameters {
	if x != nil {
		return x.Rules
	}
	return nil
...
type SetLiquidityParamsRequest struct {
	...
	// subsystem for the given asset id .Note that the current set of parameters
	// will be completely overwritten by the parameters provided (if they are
	// valid), so the full set of parameters should be provided for each call.
...
func (x *SetLiquidityParamsRequest) GetAssetId() string {
	if x != nil {
		return x.AssetId
	}
	return ""
...
var file_client_proto_rawDesc = []byte{
	...
	0x61, 0x72, 0x61, 0x6d, 0x73, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x22, 0xba, 0x01, 0x0a,
	0x1a, 0x47, 0x65, 0x74, 0x4c, 0x69, 0x71, 0x75, 0x69, 0x64, 0x69, 0x74, 0x79, 0x50, 0x61, 0x72,
	0x61, 0x6d, 0x73, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x44, 0x0a, 0x05, 0x72,
	0x75, 0x6c, 0x65, 0x73, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x2e, 0x2e, 0x6c, 0x6f, 0x6f,
	...
	0x73, 0x1a, 0x56, 0x0a, 0x0a, 0x52, 0x75, 0x6c, 0x65, 0x73, 0x45, 0x6e, 0x74, 0x72, 0x79, 0x12,
	0x10, 0x0a, 0x03, 0x6b, 0x65, 0x79, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x03, 0x6b, 0x65,
	0x79, 0x12, 0x32, 0x0a, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b,
	0x32, 0x1c, 0x2e, 0x6c, 0x6f, 0x6f, 0x70, 0x72, 0x70, 0x63, 0x2e, 0x4c, 0x69, 0x71, 0x75, 0x69,
	0x64, 0x69, 0x74, 0x79, 0x50, 0x61, 0x72, 0x61, 0x6d, 0x65, 0x74, 0x65, 0x72, 0x73, 0x52, 0x05,
	0x76, 0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x22, 0x94, 0x09, 0x0a, 0x13, 0x4c, 0x69,
	...
	0x72, 0x65, 0x73, 0x68, 0x6f, 0x6c, 0x64, 0x22, 0x74, 0x0a, 0x19, 0x53, 0x65, 0x74, 0x4c, 0x69,
	...
	0x72, 0x73, 0x12, 0x19, 0x0a, 0x08, 0x61, 0x73, 0x73, 0x65, 0x74, 0x5f, 0x69, 0x64, 0x18, 0x02,
	0x20, 0x01, 0x28, 0x09, 0x52, 0x07, 0x61, 0x73, 0x73, 0x65, 0x74, 0x49, 0x64, 0x22, 0x1c, 0x0a,
	...
	0x45, 0x53, 0x53, 0x5f, 0x53, 0x57, 0x41, 0x50, 0x10, 0x0b, 0x32, 0xef, 0x11, 0x0a, 0x0a, 0x53,
	...
	0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x5d, 0x0a, 0x12, 0x47, 0x65, 0x74, 0x4c,
	...
	0x73, 0x74, 0x1a, 0x23, 0x2e, 0x6c, 0x6f, 0x6f, 0x70, 0x72, 0x70, 0x63, 0x2e, 0x47, 0x65, 0x74,
	0x4c, 0x69, 0x71, 0x75, 0x69, 0x64, 0x69, 0x74, 0x79, 0x50, 0x61, 0x72, 0x61, 0x6d, 0x73, 0x52,
	0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x5d, 0x0a, 0x12, 0x53, 0x65, 0x74, 0x4c, 0x69,
...
var file_client_proto_goTypes = []any{
	...
	(*GetLiquidityParamsResponse)(nil),        // 35: looprpc.GetLiquidityParamsResponse
	(*LiquidityParameters)(nil),               // 36: looprpc.LiquidityParameters
	...
	nil,                                       // 77: looprpc.GetLiquidityParamsResponse.RulesEntry
...
var file_client_proto_depIdxs = []int32{
	...
	77, // 18: looprpc.GetLiquidityParamsResponse.rules:type_name -> looprpc.GetLiquidityParamsResponse.RulesEntry
	37, // 19: looprpc.LiquidityParameters.rules:type_name -> looprpc.LiquidityRule
	...
	36, // 23: looprpc.SetLiquidityParamsRequest.parameters:type_name -> looprpc.LiquidityParameters
	...
	36, // 40: looprpc.GetLiquidityParamsResponse.RulesEntry.value:type_name -> looprpc.LiquidityParameters
	...
	35, // 85: looprpc.SwapClient.GetLiquidityParams:output_type -> looprpc.GetLiquidityParamsResponse
...
func file_client_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_client_proto_msgTypes[26].Exporter = func(v any, i int) any {
			switch v := v.(*GetLiquidityParamsResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache

...
type StaticAddressSummaryResponse struct {
	...
	ValueLoopedIn int64 `protobuf:"varint,7,opt,name=value_looped_in,json=valueLoopedIn,proto3" json:"value_looped_in,omitempty"`
	// The total value of all htlc timeout sweeps that the client swept.
	ValueHtlcTimeoutSweeps int64 `protobuf:"varint,8,opt,name=value_htlc_timeout_sweeps,json=valueHtlcTimeoutSweeps,proto3" json:"value_htlc_timeout_sweeps,omitempty"`
...
func (x *StaticAddressSummaryResponse) GetValueLoopedIn() int64 {
	if x != nil {
		return x.ValueLoopedIn
	}
	return 0
}

func (x *StaticAddressSummaryResponse) GetValueHtlcTimeoutSweeps() int64 {
	if x != nil {
		return x.ValueHtlcTimeoutSweeps
	}
	return 0
}
...
type StaticAddressLoopInRequest struct {
	...
	// Maximum we are willing to pay the server for the swap. This value is not
	// disclosed in the swap initiation call, but if the server asks for a higher
	// fee, we abort the swap. Typically this value is taken from the response of
	// the GetQuote call.
	MaxSwapFee int64 `protobuf:"varint,2,opt,name=max_swap_fee,json=maxSwapFee,proto3" json:"max_swap_fee,omitempty"`
	// Optionally the client can specify the last hop pubkey when requesting a
	// loop-in quote. This is useful to get better off-chain routing fee from the
...
func (x *StaticAddressLoopInRequest) GetMaxSwapFee() int64 {
	if x != nil {
		return x.MaxSwapFee
	}
	return 0
...
var file_client_proto_rawDesc = []byte{
	...
	0xb9, 0x03, 0x0a, 0x1c, 0x53, 0x74, 0x61, 0x74, 0x69, 0x63, 0x41, 0x64, 0x64, 0x72, 0x65, 0x73,
	...
	,
	...
	0x6e, 0x48, 0x65, 0x69, 0x67, 0x68, 0x74, 0x22, 0xfa, 0x01, 0x0a, 0x1a, 0x53, 0x74, 0x61, 0x74,
	...
	0x69, 0x6e, 0x74, 0x73, 0x12, 0x20, 0x0a, 0x0c, 0x6d, 0x61, 0x78, 0x5f, 0x73, 0x77, 0x61, 0x70,
	0x5f, 0x66, 0x65, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x03, 0x52, 0x0a, 0x6d, 0x61, 0x78, 0x53,
	0x77, 0x61, 0x70, 0x46, 0x65, 0x65, 0x12, 0x19, 0x0a, 0x08, 0x6c, 0x61, 0x73, 0x74, 0x5f, 0x68,
	...
	0x76, 0x61, 0x74, 0x65, 0x22, 0x1d, 0x0a, 0x1b, 0x53, 0x74, 0x61, 0x74, 0x69, 0x63, 0x41, 0x64,
	...
	0x4e, 0x54, 0x10, 0x0d, 0x2a, 0xee, 0x01, 0x0a, 0x0c, 0x44, 0x65, 0x70, 0x6f, 0x73, 0x69, 0x74,
	...
	0x44, 0x10, 0x0a, 0x12, 0x10, 0x0a, 0x0c, 0x46, 0x41, 0x49, 0x4c, 0x45, 0x44, 0x5f, 0x53, 0x54,
	0x41, 0x54, 0x45, 0x10, 0x0b, 0x32, 0xb6, 0x0f, 0x0a, 0x0a, 0x53, 0x77, 0x61, 0x70, 0x43, 0x6c,

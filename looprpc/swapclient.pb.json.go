...
func RegisterSwapClientJSONCallbacks(registry map[string]func(ctx context.Context,
	...
	registry["looprpc.SwapClient.FundStaticAddress"] = func(ctx context.Context,
		conn *grpc.ClientConn, reqJSON string, callback func(string, error)) {

		req := &FundStaticAddressRequest{}
		err := marshaler.Unmarshal([]byte(reqJSON), req)
		if err != nil {
			callback("", err)
			return
	...
	registry["looprpc.SwapClient.UpdateStaticAddressLabel"] = func(ctx context.Context,
		conn *grpc.ClientConn, reqJSON string, callback func(string, error)) {

		req := &UpdateStaticAddressLabelRequest{}
		err := marshaler.Unmarshal([]byte(reqJSON), req)
		if err != nil {
			callback("", err)
			return
		...
		client := NewSwapClientClient(conn)
		resp, err := client.UpdateStaticAddressLabel(ctx, req)
		if err != nil {
			callback("", err)
			return
		}

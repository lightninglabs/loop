...
func RegisterSwapClientJSONCallbacks(registry map[string]func(ctx context.Context,
	...
	registry["looprpc.SwapClient.Recover"] = func(ctx context.Context,
		conn *grpc.ClientConn, reqJSON string, callback func(string, error)) {
	...
	registry["looprpc.SwapClient.RecoverDeposit"] = func(ctx context.Context,
		conn *grpc.ClientConn, reqJSON string, callback func(string, error)) {

		req := &RecoverDepositRequest{}
		err := marshaler.Unmarshal([]byte(reqJSON), req)
		if err != nil {
			callback("", err)
			return
		...
		client := NewSwapClientClient(conn)
		resp, err := client.RecoverDeposit(ctx, req)
		if err != nil {
			callback("", err)
			return
		}

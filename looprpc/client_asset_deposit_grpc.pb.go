...
type AssetDepositClientClient interface {
	...
	PushAssetDepositHtlcSig(ctx context.Context, in *PushAssetDepositHtlcSigRequest, opts ...grpc.CallOption) (*PushAssetDepositHtlcSigResponse, error)
}
...
func (c *assetDepositClientClient) PushAssetDepositHtlcSig(ctx context.Context, in *PushAssetDepositHtlcSigRequest, opts ...grpc.CallOption) (*PushAssetDepositHtlcSigResponse, error) {
	out := new(PushAssetDepositHtlcSigResponse)
	err := c.cc.Invoke(ctx, "/looprpc.AssetDepositClient/PushAssetDepositHtlcSig", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type AssetDepositClientServer interface {
	...
	PushAssetDepositHtlcSig(context.Context, *PushAssetDepositHtlcSigRequest) (*PushAssetDepositHtlcSigResponse, error)
...
func (UnimplementedAssetDepositClientServer) PushAssetDepositHtlcSig(context.Context, *PushAssetDepositHtlcSigRequest) (*PushAssetDepositHtlcSigResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method PushAssetDepositHtlcSig not implemented")
}
...
func _AssetDepositClient_PushAssetDepositHtlcSig_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(PushAssetDepositHtlcSigRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AssetDepositClientServer).PushAssetDepositHtlcSig(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/looprpc.AssetDepositClient/PushAssetDepositHtlcSig",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AssetDepositClientServer).PushAssetDepositHtlcSig(ctx, req.(*PushAssetDepositHtlcSigRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var AssetDepositClient_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "PushAssetDepositHtlcSig",
			Handler:    _AssetDepositClient_PushAssetDepositHtlcSig_Handler,
		},
	},

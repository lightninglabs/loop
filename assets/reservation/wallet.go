...
func (w *WalletVerifier) Inspect(ctx context.Context,
	...
	status, err := w.Verify(ctx, r, r.ReservationProof)
	...
	return w.Chain.WaitForChange(ctx, *r.FundingOutpoint,
		terminal.AnchorTx.TxOut[r.FundingOutpoint.Index].PkScript,

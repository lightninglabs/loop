...
func TestNewKitValidation(t *testing.T) {
	...
	emptyParams := cloneAddressParams(address.ChainParams{})
	require.Nil(t, emptyParams.Params)
...
// newWitnessFixture creates a proof-bound deposit and multi-input sweep packet.

...
var (
	...
	// DefaultMacFilename is the default file name for the autogenerated
	// loop macaroon.
	DefaultMacFilename = "loop.macaroon"
...
func Validate(cfg *Config) error {
	...
	// There currently is only one macaroon file and we want to store it in
	// the namespaced network directory.
	if cfg.MacPath == "" {
		cfg.MacPath = filepath.Join(cfg.DataDir, DefaultMacFilename)
	}

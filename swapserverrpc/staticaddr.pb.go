...
// DepositConfirmationStatus reports the confirmation state of a single deposit
// that does not meet the required confirmation threshold.
type DepositConfirmationStatus struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	// The deposit outpoint in format txid:idx.
	Outpoint string `protobuf:"bytes,1,opt,name=outpoint,proto3" json:"outpoint,omitempty"`
	// Current number of confirmations the deposit has.
	CurrentConfirmations int32 `protobuf:"varint,2,opt,name=current_confirmations,json=currentConfirmations,proto3" json:"current_confirmations,omitempty"`
	// Required number of confirmations based on risk assessment.
	...
	// Estimated blocks to wait until requirement is met.
	BlocksToWait int32 `protobuf:"varint,4,opt,name=blocks_to_wait,json=blocksToWait,proto3" json:"blocks_to_wait,omitempty"`
}

func (x *DepositConfirmationStatus) Reset() {
	*x = DepositConfirmationStatus{}
	if protoimpl.UnsafeEnabled {
...
func (x *DepositConfirmationStatus) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*DepositConfirmationStatus) ProtoMessage() {}

func (x *DepositConfirmationStatus) ProtoReflect() protoreflect.Message {
	mi := &file_staticaddr_proto_msgTypes[17]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use DepositConfirmationStatus.ProtoReflect.Descriptor instead.
func (*DepositConfirmationStatus) Descriptor() ([]byte, []int) {
	return file_staticaddr_proto_rawDescGZIP(), []int{17}
}

func (x *DepositConfirmationStatus) GetOutpoint() string {
	if x != nil {
		return x.Outpoint
	}
	return ""
...
func (x *DepositConfirmationStatus) GetCurrentConfirmations() int32 {
	if x != nil {
...
func (x *DepositConfirmationStatus) GetRequiredConfirmations() int32 {
	if x != nil {
...
func (x *DepositConfirmationStatus) GetBlocksToWait() int32 {
	if x != nil {
		return x.BlocksToWait
	}
	return 0
}

// InsufficientConfirmationsDetails provides structured information about
// deposits that don't meet dynamic confirmation requirements. This is
// attached as error details to FailedPrecondition errors.
type InsufficientConfirmationsDetails struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	// Status of each deposit that has insufficient confirmations.
	Deposits []*DepositConfirmationStatus `protobuf:"bytes,1,rep,name=deposits,proto3" json:"deposits,omitempty"`
	// Maximum blocks to wait across all deposits.
	MaxBlocksToWait int32 `protobuf:"varint,2,opt,name=max_blocks_to_wait,json=maxBlocksToWait,proto3" json:"max_blocks_to_wait,omitempty"`
}

func (x *InsufficientConfirmationsDetails) Reset() {
	*x = InsufficientConfirmationsDetails{}
	if protoimpl.UnsafeEnabled {
...
func (x *InsufficientConfirmationsDetails) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*InsufficientConfirmationsDetails) ProtoMessage() {}

func (x *InsufficientConfirmationsDetails) ProtoReflect() protoreflect.Message {
	mi := &file_staticaddr_proto_msgTypes[18]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use InsufficientConfirmationsDetails.ProtoReflect.Descriptor instead.
func (*InsufficientConfirmationsDetails) Descriptor() ([]byte, []int) {
	return file_staticaddr_proto_rawDescGZIP(), []int{18}
}

func (x *InsufficientConfirmationsDetails) GetDeposits() []*DepositConfirmationStatus {
	if x != nil {
		return x.Deposits
	}
	return nil
...
func (x *InsufficientConfirmationsDetails) GetMaxBlocksToWait() int32 {
	if x != nil {
		return x.MaxBlocksToWait
	}
	return 0
}
...
var file_staticaddr_proto_rawDesc = []byte{
	...
	0xc9, 0x01, 0x0a, 0x19, 0x44, 0x65, 0x70, 0x6f, 0x73, 0x69, 0x74, 0x43, 0x6f, 0x6e, 0x66, 0x69,
	0x72, 0x6d, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x12, 0x1a, 0x0a,
	0x08, 0x6f, 0x75, 0x74, 0x70, 0x6f, 0x69, 0x6e, 0x74, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52,
	0x08, 0x6f, 0x75, 0x74, 0x70, 0x6f, 0x69, 0x6e, 0x74, 0x12, 0x33, 0x0a, 0x15, 0x63, 0x75, 0x72,
	0x72, 0x65, 0x6e, 0x74, 0x5f, 0x63, 0x6f, 0x6e, 0x66, 0x69, 0x72, 0x6d, 0x61, 0x74, 0x69, 0x6f,
	0x6e, 0x73, 0x18, 0x02, 0x20, 0x01, 0x28, 0x05, 0x52, 0x14, 0x63, 0x75, 0x72, 0x72, 0x65, 0x6e,
	0x74, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x72, 0x6d, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x12, 0x35,
	...
	,
	...
	,
...
var file_staticaddr_proto_msgTypes = make([]protoimpl.MessageInfo, 22)
var file_staticaddr_proto_goTypes = []any{
	...
	(*DepositConfirmationStatus)(nil),              // 18: looprpc.DepositConfirmationStatus
	(*InsufficientConfirmationsDetails)(nil),       // 19: looprpc.InsufficientConfirmationsDetails
	nil,                                            // 20: looprpc.ServerPsbtWithdrawRequest.DepositToNoncesEntry
	nil,                                            // 21: looprpc.ServerPsbtWithdrawResponse.SigningInfoEntry
	nil,                                            // 22: looprpc.PushStaticAddressSweeplessSigsRequest.SigningInfoEntry
	(*PrevoutInfo)(nil),                            // 23: looprpc.PrevoutInfo
}
var file_staticaddr_proto_depIdxs = []int32{
	...
	23, // 2: looprpc.ServerWithdrawRequest.outpoints:type_name -> looprpc.PrevoutInfo
	...
	21, // 4: looprpc.ServerPsbtWithdrawResponse.signing_info:type_name -> looprpc.ServerPsbtWithdrawResponse.SigningInfoEntry
	...
	22, // 12: looprpc.PushStaticAddressSweeplessSigsRequest.signing_info:type_name -> looprpc.PushStaticAddressSweeplessSigsRequest.SigningInfoEntry
	18, // 13: looprpc.InsufficientConfirmationsDetails.deposits:type_name -> looprpc.DepositConfirmationStatus
...
func file_staticaddr_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_staticaddr_proto_msgTypes[17].Exporter = func(v any, i int) any {
			switch v := v.(*DepositConfirmationStatus); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_staticaddr_proto_msgTypes[18].Exporter = func(v any, i int) any {
			switch v := v.(*InsufficientConfirmationsDetails); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache

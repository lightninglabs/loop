...
// InitAssetDepositSigningSessionReq is the request to the Server to initialize
// a signing session for one or more deposits. The Server will return a list of
// nonces that the client must use to sign the deposits.
type InitAssetDepositSigningSessionReq struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	// deposit_ids is a list of deposit IDs to sign.
	DepositIds []string `protobuf:"bytes,1,rep,name=deposit_ids,json=depositIds,proto3" json:"deposit_ids,omitempty"`
}

func (x *InitAssetDepositSigningSessionReq) Reset() {
	*x = InitAssetDepositSigningSessionReq{}
	if protoimpl.UnsafeEnabled {
...
func (x *InitAssetDepositSigningSessionReq) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*InitAssetDepositSigningSessionReq) ProtoMessage() {}

func (x *InitAssetDepositSigningSessionReq) ProtoReflect() protoreflect.Message {
	mi := &file_asset_deposit_proto_msgTypes[5]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use InitAssetDepositSigningSessionReq.ProtoReflect.Descriptor instead.
func (*InitAssetDepositSigningSessionReq) Descriptor() ([]byte, []int) {
	return file_asset_deposit_proto_rawDescGZIP(), []int{5}
}

func (x *InitAssetDepositSigningSessionReq) GetDepositIds() []string {
	if x != nil {
		return x.DepositIds
	}
	return nil
...
// InitDepositSigningSessionRes contains a list of nonces that the client must
// use to sign the deposits.
type InitAssetDepositSigningSessionRes struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	// nonces is a map which maps deposit_id to nonce. The client can use these
	// nonces at most once to sign the deposits. The server may revoke nonces
	// in which case the client needs to re-initiate the signing session.
	Nonces map[string][]byte `protobuf:"bytes,1,rep,name=nonces,proto3" json:"nonces,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
}

func (x *InitAssetDepositSigningSessionRes) Reset() {
	*x = InitAssetDepositSigningSessionRes{}
	if protoimpl.UnsafeEnabled {
...
func (x *InitAssetDepositSigningSessionRes) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*InitAssetDepositSigningSessionRes) ProtoMessage() {}

func (x *InitAssetDepositSigningSessionRes) ProtoReflect() protoreflect.Message {
	mi := &file_asset_deposit_proto_msgTypes[6]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use InitAssetDepositSigningSessionRes.ProtoReflect.Descriptor instead.
func (*InitAssetDepositSigningSessionRes) Descriptor() ([]byte, []int) {
	return file_asset_deposit_proto_rawDescGZIP(), []int{6}
}

func (x *InitAssetDepositSigningSessionRes) GetNonces() map[string][]byte {
	if x != nil {
		return x.Nonces
	}
	return nil
...
type PushAssetDepositHtlcSigsReq struct {
	...
	// hash is the hash used in the HTLC script.
	Hash []byte `protobuf:"bytes,1,opt,name=hash,proto3" json:"hash,omitempty"`
	// csv_expiry is the CSV expiry for the HTLC.
	CsvExpiry uint32 `protobuf:"varint,2,opt,name=csv_expiry,json=csvExpiry,proto3" json:"csv_expiry,omitempty"`
	...
	PartialSigs []*AssetDepositPartialSig `protobuf:"bytes,3,rep,name=partial_sigs,json=partialSigs,proto3" json:"partial_sigs,omitempty"`
	// htlc_psbt is the HTLC psbt.
	HtlcPsbt []byte `protobuf:"bytes,4,opt,name=htlc_psbt,json=htlcPsbt,proto3" json:"htlc_psbt,omitempty"`
}
...
func (x *PushAssetDepositHtlcSigsReq) GetHash() []byte {
	if x != nil {
		return x.Hash
	}
	return nil
...
func (x *PushAssetDepositHtlcSigsReq) GetCsvExpiry() uint32 {
	if x != nil {
		return x.CsvExpiry
	}
	return 0
...
func (x *PushAssetDepositKeysReq) Reset() {
	*x = PushAssetDepositKeysReq{}
	if protoimpl.UnsafeEnabled {
		mi := &file_asset_deposit_proto_msgTypes[9]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*PushAssetDepositKeysReq) Descriptor() ([]byte, []int) {
	return file_asset_deposit_proto_rawDescGZIP(), []int{9}
}
...
func (x *PushAssetDepositKeysRes) Reset() {
	*x = PushAssetDepositKeysRes{}
	if protoimpl.UnsafeEnabled {
		mi := &file_asset_deposit_proto_msgTypes[10]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*PushAssetDepositKeysRes) Descriptor() ([]byte, []int) {
	return file_asset_deposit_proto_rawDescGZIP(), []int{10}
}
...
var file_asset_deposit_proto_rawDesc = []byte{
	...
	,
	...
	,
...
var file_asset_deposit_proto_msgTypes = make([]protoimpl.MessageInfo, 14)
var file_asset_deposit_proto_goTypes = []any{
	...
	(*InitAssetDepositSigningSessionReq)(nil), // 6: looprpc.InitAssetDepositSigningSessionReq
	(*InitAssetDepositSigningSessionRes)(nil), // 7: looprpc.InitAssetDepositSigningSessionRes
	(*PushAssetDepositHtlcSigsReq)(nil),       // 8: looprpc.PushAssetDepositHtlcSigsReq
	(*PushAssetDepositHtlcSigsRes)(nil),       // 9: looprpc.PushAssetDepositHtlcSigsRes
	(*PushAssetDepositKeysReq)(nil),           // 10: looprpc.PushAssetDepositKeysReq
	(*PushAssetDepositKeysRes)(nil),           // 11: looprpc.PushAssetDepositKeysRes
	nil,                                       // 12: looprpc.WithdrawAssetDepositsServerRes.DepositKeysEntry
	nil,                                       // 13: looprpc.InitAssetDepositSigningSessionRes.NoncesEntry
	nil,                                       // 14: looprpc.PushAssetDepositKeysReq.DepositKeysEntry
}
var file_asset_deposit_proto_depIdxs = []int32{
	12, // 0: looprpc.WithdrawAssetDepositsServerRes.deposit_keys:type_name -> looprpc.WithdrawAssetDepositsServerRes.DepositKeysEntry
	13, // 1: looprpc.InitAssetDepositSigningSessionRes.nonces:type_name -> looprpc.InitAssetDepositSigningSessionRes.NoncesEntry
	5,  // 2: looprpc.PushAssetDepositHtlcSigsReq.partial_sigs:type_name -> looprpc.AssetDepositPartialSig
	14, // 3: looprpc.PushAssetDepositKeysReq.deposit_keys:type_name -> looprpc.PushAssetDepositKeysReq.DepositKeysEntry
	1,  // 4: looprpc.AssetDepositService.NewAssetDeposit:input_type -> looprpc.NewAssetDepositServerReq
	3,  // 5: looprpc.AssetDepositService.WithdrawAssetDeposits:input_type -> looprpc.WithdrawAssetDepositsServerReq
	6,  // 6: looprpc.AssetDepositService.InitAssetDepositSigningSession:input_type -> looprpc.InitAssetDepositSigningSessionReq
	8,  // 7: looprpc.AssetDepositService.PushAssetDepositHtlcSigs:input_type -> looprpc.PushAssetDepositHtlcSigsReq
	10, // 8: looprpc.AssetDepositService.PushAssetDepositKeys:input_type -> looprpc.PushAssetDepositKeysReq
	2,  // 9: looprpc.AssetDepositService.NewAssetDeposit:output_type -> looprpc.NewAssetDepositServerRes
	4,  // 10: looprpc.AssetDepositService.WithdrawAssetDeposits:output_type -> looprpc.WithdrawAssetDepositsServerRes
	7,  // 11: looprpc.AssetDepositService.InitAssetDepositSigningSession:output_type -> looprpc.InitAssetDepositSigningSessionRes
	9,  // 12: looprpc.AssetDepositService.PushAssetDepositHtlcSigs:output_type -> looprpc.PushAssetDepositHtlcSigsRes
	11, // 13: looprpc.AssetDepositService.PushAssetDepositKeys:output_type -> looprpc.PushAssetDepositKeysRes
...
func file_asset_deposit_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_asset_deposit_proto_msgTypes[5].Exporter = func(v any, i int) any {
			switch v := v.(*InitAssetDepositSigningSessionReq); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_asset_deposit_proto_msgTypes[6].Exporter = func(v any, i int) any {
			switch v := v.(*InitAssetDepositSigningSessionRes); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_asset_deposit_proto_msgTypes[9].Exporter = func(v any, i int) any {
		...
		file_asset_deposit_proto_msgTypes[10].Exporter = func(v any, i int) any {

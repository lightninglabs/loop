...
// Taproot Assets still requires the pre-release lndclient revision. Use the
// release containing that revision instead.
replace github.com/lightninglabs/lndclient => github.com/lightninglabs/lndclient v0.21.0-3

...
func TestLegacyOutgoingChannel(t *testing.T) {
	...
	legacyDb := map[string]any{
		...
		"uncharge-swaps": map[string]any{
			Hex(
				"2a595d79a55168970532805ae20c9b5fac98f04db79" +
					"ba4c6ae9b9ac0f206359e",
			): map[string]any{
				"contract": Hex(
					"1562d6fbec1400000101010102020202030"+
						"303030404040401010101020202"+
						"020303030304040404000000000"+
						"00000640d707265706179696e76"+
						"6f6963650101010101010101010"+
						"101010101010101010101010101"+
						"010101010101010101020101010"+
						"101010101010101010101010101"+
						"010101010101010101010101010"+
						"101030000009000000000000000"+
						"0a0000000000000014000000000"+
						"000002800000063223347454e55"+
						"6d6e4552745766516374344e656"+
						"76f6d557171745a757a59475077"+
						"42530b73776170696e766f69636"+
						"500000002000000000000001e",
				) + legacyOutgoingChannel + Hex(
					"1562d6fbec140000",
				),
				"updates": map[string]any{
					Hex("0000000000000001"): Hex(
						"1508290a92d4c00001000000000" +
							"0000000000000000000" +
							"00000000000000000000",
					),
					Hex("0000000000000002"): Hex(
						"1508290a92d4c00006000000000" +
							"0000000000000000000" +
							"00000000000000000000",
					),
				},
